  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        calc: {
          glass: "hsl(var(--calc-glass))",
          "glass-border": "hsl(var(--calc-glass-border))",
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 40px hsl(0 84% 65% / 0.15)" },
          "50%": { boxShadow: "0 0 60px hsl(0 84% 65% / 0.25)" },
        },
      },
      animation: {
        ...
        "result-flip": "result-flip 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",
